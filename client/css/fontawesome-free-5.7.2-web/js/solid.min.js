!(function () {
  let c = {}; let h = {}; try { typeof window !== 'undefined' && (c = window), typeof document !== 'undefined' && (h = document); } catch (c) {} const l = (c.navigator || {}).userAgent; const v = void 0 === l ? '' : l; const z = c; const s = h; const M = (z.document, !!s.documentElement && !!s.head && typeof s.addEventListener === 'function' && s.createElement, ~v.indexOf('MSIE') || v.indexOf('Trident/'), '___FONT_AWESOME___'); const m = (function () { try { return !0; } catch (c) { return !1; } }()); const H = z || {}; H[M] || (H[M] = {}), H[M].styles || (H[M].styles = {}), H[M].hooks || (H[M].hooks = {}), H[M].shims || (H[M].shims = []); const a = H[M]; function V(c, v) {
    const h = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks; const l = void 0 !== h && h; const z = Object.keys(v).reduce((c, h) => { const l = v[h]; returnl.icon ? c[l.iconName] = l.icon : c[h] = l, c; }, {}); typeof a.hooks.addPack !== 'function' || l ? a.styles[c] = (function (z) {
